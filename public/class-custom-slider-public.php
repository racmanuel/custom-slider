...
class Custom_Slider_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/custom-slider-public.js', array( 'jquery' ), $this->version, true );
	 ...
	 */
	public function custom_slider_shortcode_func( $atts, $content ) {
