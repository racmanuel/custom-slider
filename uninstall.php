 ...
 * of control:
 *
 * - Check if the $_REQUEST['plugin'] content actually is custom-slider/custom-slider.php
 ...
 * @since 1.0.0
 */
function custom_slider_uninstall() {

	if ( ! defined( 'WP_UNINSTALL_PLUGIN' )
		|| empty( $_REQUEST )
		|| ! isset( $_REQUEST['plugin'] )
		|| ! isset( $_REQUEST['action'] )
		|| 'custom-slider/custom-slider.php' !== $_REQUEST['plugin']
